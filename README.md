...
* In part 1, I discuss the implementation of an image-based shoe recommendation system. 
* In part 2, I experiment with using deep learning for the more complex task of product design/generation.
